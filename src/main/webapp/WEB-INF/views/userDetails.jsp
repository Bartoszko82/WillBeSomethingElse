...
<html>
	<head>
		...
		<link href="<c:url value='/static/userInfoStyle.css' />" rel="stylesheet"></link>
	...
	<body>
		...
		<p>Tasks: tu bedzie tabela z taskami</p>
		<a class="genericLink" href="<c:url value='/edit-${user.userId}-user' />">edit User</a>
		<a class="genericLink" href="<c:url value='/delete-${user.userId}-user' />">delete User</a>
		<br/>
	</body>
</html>